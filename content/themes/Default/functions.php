...
add( 'styles', THEME_LOCATION . '/assets/css/default.css',    array( 'media' => 'all', 'rel' => 'stylesheet' ) );
...
add( 'styles', '//cdnjs.cloudflare.com/ajax/libs/font-awesome/6.3.0/css/all.min.css', array( 'rel' => 'stylesheet' ) );
add( 'styles', '//fonts.googleapis.com/css?family=Raleway:100,200,300,400,500,600,700,800,900', array( 'rel' => 'stylesheet' ) );
add( 'styles', '', array( 'rel' => 'stylesheet' ) );
...
/* ADD THEME SCRIPTS */
add( 'scripts', 'https://code.jquery.com/jquery-3.6.4.min.js' );
add( 'scripts', 'https://code.jquery.com/jquery-3.6.4.slim.min.js' );
add( 'scripts', 'https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js' );
add( 'scripts', 'https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/js/bootstrap.min.js' );
...
add( 'scripts', THEME_LOCATION . '/assets/js/gtm.js' );
add( 'scripts', THEME_LOCATION . '/assets/js/analytics.js' );
add( 'scripts', THEME_LOCATION . '/assets/js/bugsnag.js' );
add( 'scripts', THEME_LOCATION . '/assets/js/default.js' );
add( 'scripts', THEME_LOCATION . '/assets/js/update-browser.js' );
